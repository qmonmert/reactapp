package tech.jhipster.reactapp.shared.collection.domain;
...
@UnitTest
class ReactappCollectionsTest {

  @Nested
  @DisplayName("Collections")
  class ReactappCollectionsCollectionsTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Collection<Object> input = null;
      Collection<Object> collection = ReactappCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Collection<String> collection = ReactappCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Set")
  class ReactappCollectionsSetTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      Set<Object> input = null;
      Set<Object> set = ReactappCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      Set<String> set = ReactappCollections.immutable(input);
  ...
  @Nested
  @DisplayName("List")
  class ReactappCollectionsListTest {

    @Test
    void shouldGetEmptyImmutableCollectionFromNullCollection() {
      List<Object> input = null;
      List<Object> list = ReactappCollections.immutable(input);
    ...
    void shouldGetImmutableCollectionFromMutableCollection() {
      ...
      input.add("value");
      List<String> list = ReactappCollections.immutable(input);
  ...
  @Nested
  @DisplayName("Map")
  class ReactappMapTest {

    @Test
    void shouldGetEmptyImmutableMapFromNullMap() {
      Map<Object, Object> input = null;
      Map<Object, Object> map = ReactappCollections.immutable(input);
    ...
    void shouldGetImmutableMapFromMutableMap() {
      ...
      input.put("key", "value");
      Map<String, String> map = ReactappCollections.immutable(input);
